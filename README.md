...
Note, that as the `"default"` Namespace has specific permissions, choosing this Namespace to deploy your AI Software Templates applications is not supported.HELLO
